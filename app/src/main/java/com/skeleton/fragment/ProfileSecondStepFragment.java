...
public class ProfileSecondStepFragment extends BaseFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_second_step_profile, container, false);
        init(view);
        ...
        ivToolbarBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ((SetProfileActivity) getActivity()).replaceFragment(new ProfileFirstStepFragment());
            }
        });
                ...
                .enqueue(new ResponseResolver<Response>(getActivity(), true, true) {
                    ...
                    public void success(final Response response) {
                        ...
                        if ("200".equals(String.valueOf(response.getStatusCode()))) {
                            ...
                            RecyclerAdaptor recyclerAdaptor = new RecyclerAdaptor(categoriesList, getContext(), ProfileSecondStepFragment.this);
