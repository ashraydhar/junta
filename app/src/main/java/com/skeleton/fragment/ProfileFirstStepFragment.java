...
/**
 * Created by Ashray on 15/5/17.
 */

public class ProfileFirstStepFragment extends BaseFragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable final Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_first_step_profile, container, false);
        init(view);
        getProfileItems();
    ...
    /**
     * sets on click listener for all drop down menu items.
     * @param v
     */
    @Override
    public void onClick(final View v) {
        ...
        apiInterface.getUserProfileConstants().enqueue(new ResponseResolver<Response>(getActivity(), true, true) {
            ...
            public void success(final Response response) {
                if ("200".equals(String.valueOf(response.getStatusCode()))) {
                    ...
                    etRelationshipHistory.setOnClickListener(ProfileFirstStepFragment.this);
                    etEthnicity.setOnClickListener(ProfileFirstStepFragment.this);
                    etReligion.setOnClickListener(ProfileFirstStepFragment.this);
                    etHeight.setOnClickListener(ProfileFirstStepFragment.this);
                    etBodyType.setOnClickListener(ProfileFirstStepFragment.this);
                    etSmoking.setOnClickListener(ProfileFirstStepFragment.this);
                    etDrinking.setOnClickListener(ProfileFirstStepFragment.this);
                    etOrientation.setOnClickListener(ProfileFirstStepFragment.this);
                    btnNext.setOnClickListener(ProfileFirstStepFragment.this);
                }
            }
                ...
                .enqueue(new ResponseResolver<com.skeleton.model.Response>(getActivity(), false, false) {
                    ...
                    public void success(final com.skeleton.model.Response response) {
                        ...
                        if ("200".equals(response.getStatusCode().toString())) {
                            ...
                            ((SetProfileActivity) getActivity()).replaceFragment(new ProfileSecondStepFragment());
                        }
                    }
